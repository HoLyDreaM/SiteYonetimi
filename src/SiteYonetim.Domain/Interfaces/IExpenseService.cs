...
{
    Task<Expense?> GetByIdAsync(Guid id, bool includeAttachments = false, CancellationToken ct = default);
    ...
    Task AddAttachmentAsync(ExpenseAttachment attachment, CancellationToken ct = default);
}
